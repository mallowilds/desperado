...
// Bones
set_color_profile_slot( 0, 0, 221, 157, 136 );
set_color_profile_slot_range( 0, 1, 31, 42 );

// Horns
set_color_profile_slot( 0, 1, 136, 192, 219 );
set_color_profile_slot_range( 1, 1, 30, 41 );

// Smog
set_color_profile_slot( 0, 2, 43, 34, 34 );
set_color_profile_slot_range( 2, 1, 10, 37 );

// Ash
set_color_profile_slot( 0, 3, 32, 32, 32 );
set_color_profile_slot_range( 3, 1, 1, 1 );

// Coat
set_color_profile_slot( 0, 4, 106, 87, 65 );
set_color_profile_slot_range( 4, 1, 2, 18 );

// Fire
set_color_profile_slot( 0, 5, 255, 127, 0 );
set_color_profile_slot_range( 5, 1, 1, 1 );

// Fireyellow
set_color_profile_slot( 0, 6, 255, 230, 0 );
...
set_color_profile_slot( 1, 1, 140, 147, 173 ); //Horns
set_color_profile_slot( 1, 2, 55, 69, 130 ); //Smog
set_color_profile_slot( 1, 3, 5, 29, 46 ); //Ash
set_color_profile_slot( 1, 4, 35, 68, 161 ); //Coat
...
set_color_profile_slot( 2, 1, 219, 98, 85 ); //Horns
set_color_profile_slot( 2, 2, 107, 29, 0 ); //Smog
set_color_profile_slot( 2, 3, 255, 128, 0 ); //Ash
set_color_profile_slot( 2, 4, 84, 55, 51 ); //Coat
...
set_color_profile_slot( 3, 1, 81, 92, 105 ); //Horns
set_color_profile_slot( 3, 2, 33, 66, 33 ); //Smog
set_color_profile_slot( 3, 3, 26, 41, 28 ); //Ash
set_color_profile_slot( 3, 4, 120, 113, 78 ); //Coat
...
set_color_profile_slot( 4, 1, 124, 127, 135 ); //Horns
set_color_profile_slot( 4, 2, 74, 76, 105 ); //Smog
set_color_profile_slot( 4, 3, 181, 160, 222 ); //Ash
set_color_profile_slot( 4, 4, 106, 107, 153 ); //Coat
...
set_color_profile_slot( 4, 8, 37, 46, 54 ); //Firedark

// dust & desire - reiga
set_color_profile_slot( 5, 0, 212, 207, 209 ); //Bones
set_color_profile_slot( 5, 1, 181, 177, 181 ); //Horns
set_color_profile_slot( 5, 2, 94, 80, 86 ); //Smog
set_color_profile_slot( 5, 3, 59, 42, 42 ); //Ash
set_color_profile_slot( 5, 4, 153, 121, 134 ); //Coat
...
set_color_profile_slot( 5, 8, 59, 42, 42 ); //Firedark

// doubt - hyu
set_color_profile_slot( 6, 0, 160, 143, 196 ); //Bones
set_color_profile_slot( 6, 1, 206, 192, 207 ); //Horns
set_color_profile_slot( 6, 2, 20, 12, 36 ); //Smog
set_color_profile_slot( 6, 3, 46, 13, 59 ); //Ash
set_color_profile_slot( 6, 4, 105, 38, 86 ); //Coat
...
set_color_profile_slot( 6, 8, 255, 127, 0 ); //Firedark

// timeless
set_color_profile_slot( 7, 0, 194, 212, 125 ); //Bones
set_color_profile_slot( 7, 1, 89, 145, 58 ); //Horns
set_color_profile_slot( 7, 2, 89, 145, 58 ); //Smog
set_color_profile_slot( 7, 3, 194, 212, 125 ); //Ash
set_color_profile_slot( 7, 4, 89, 145, 58 ); //Coat
...
set_color_profile_slot( 8, 1, 166, 172, 214 ); //Horns
set_color_profile_slot( 8, 2, 100, 109, 179 ); //Smog
set_color_profile_slot( 8, 3, 54, 18, 104 ); //Ash
set_color_profile_slot( 8, 4, 79, 61, 94 ); //Coat
...
// reap
set_color_profile_slot( 9, 0, 170, 171, 167 ); //Bones
set_color_profile_slot( 9, 1, 170, 171, 167 ); //Horns
set_color_profile_slot( 9, 2, 22, 22, 26 ); //Smog
set_color_profile_slot( 9, 3, 24, 24, 26 ); //Ash
set_color_profile_slot( 9, 4, 115, 73, 25 ); //Coat
set_color_profile_slot( 9, 5, 255, 127, 0 ); //Fire
set_color_profile_slot( 9, 6, 255, 230, 0 ); //Fireyellow
set_color_profile_slot( 9, 7, 170, 170, 170 ); //Gun
set_color_profile_slot( 9, 8, 130, 0, 0 ); //Firedark

// pyrrhic
set_color_profile_slot( 10, 0, 132, 141, 145 ); //Bones
set_color_profile_slot( 10, 1, 177, 210, 227 ); //Horns
set_color_profile_slot( 10, 2, 84, 98, 107 ); //Smog
set_color_profile_slot( 10, 3, 36, 23, 7 ); //Ash
set_color_profile_slot( 10, 4, 94, 68, 38 ); //Coat
set_color_profile_slot( 10, 5, 51, 59, 143 ); //Fire
set_color_profile_slot( 10, 6, 119, 178, 212 ); //Fireyellow
set_color_profile_slot( 10, 7, 177, 189, 196 ); //Gun
set_color_profile_slot( 10, 8, 51, 59, 143 ); //Firedark

// baja
set_color_profile_slot( 11, 0, 139, 194, 189 ); //Bones
set_color_profile_slot( 11, 1, 86, 173, 97 ); //Horns
set_color_profile_slot( 11, 2, 8, 117, 75 ); //Smog
set_color_profile_slot( 11, 3, 29, 38, 29 ); //Ash
set_color_profile_slot( 11, 4, 29, 116, 108 ); //Coat
set_color_profile_slot( 11, 5, 86, 173, 97 ); //Fire
set_color_profile_slot( 11, 6, 84, 255, 108 ); //Fireyellow
set_color_profile_slot( 11, 7, 161, 205, 208 ); //Gun
...
set_color_profile_slot( 12, 5, 0, 255, 0 ); //Fire
set_color_profile_slot( 12, 6, 0, 255, 0 ); //Fireyellow
