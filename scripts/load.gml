...
sprite_change_offset("ftilt_emp_skulless", 156, 194);
...
sprite_change_offset("skullactive_ea", 156, 194);
sprite_change_offset("skullhurt_ea", 156, 194);
sprite_change_offset("skulldie_ea",156, 194);
sprite_change_offset("skullnspec_ea", 160, 162); // This one needs to rotate
...
sprite_change_offset("nspecflash", 118, 122)
...
sprite_change_offset("ea_sign_icons", -1, -5);


sprite_change_offset("ashpart_1", 7, 7);
sprite_change_offset("ashpart_2", 7, 7);
sprite_change_offset("ashpart_3", 7, 7);
sprite_change_offset("ashpart_4", 7, 7);
sprite_change_offset("ashpart_5", 7, 7);
sprite_change_offset("ashpart_6", 7, 7);
//not done
