...
switch state {
    ...
    case 21:
        ...
        if (screen_wrap && spr_dir == -1 && x+hsp < view_get_xview()) draw_sprite_ext(sprite_get("taunt_shot"), 0, x+view_get_wview(), y, 1, 1, move_angle, c_white, 1);
        else if (screen_wrap && spr_dir == 1 && x+hsp > view_get_xview()+view_get_wview()) draw_sprite_ext(sprite_get("taunt_shot"), 0, x-view_get_wview(), y, 1, 1, move_angle, c_white, 1);
        shader_end();
        break;
